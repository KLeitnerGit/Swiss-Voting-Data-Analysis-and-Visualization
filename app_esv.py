...
app.layout = html.Div([
    html.H1("Swiss Voting Data Analysis and Visualization (1848-2023)", style={'textAlign': 'center'}),
        html.P("This interactive graph allows you to explore extreme Swiss voting results over the years. It emphasizes the 95th and 5th quantiles of voting data to highlight the most and least supported votes over time, in relationship to the sum of the voter shares of all parties that recommended their voters to vote 'Yes' ('yes camp') represented by the color of the points."),
    html.P("One interesting extreme example is 'Der Beschluss für den Einbau von Luftschutzräumen' ('The decision for the installation of air raid shelters') in 1952: Although the 'yes camp' counts for around 60%, it received only 15.9% popular acceptance. Finally, the highest popular acceptance (94%) was received by the Constitutional basis for a one-time war tax in 1915, while the lowest popular acceptance (2.7%) was received by the Grain precaution initiative in 1929."),
    html.P("The data used for this purpose comes from the University of Bern. The Année Politique Suisse, based there, maintains a comprehensive dataset (Swissvotes) on all votes that have taken place since the founding of the modern federal state in 1848. "),
    html.A("Access the Swissvotes dataset here", href='https://swissvotes.ch/page/dataset', target='_blank', style={'textAlign': 'center', 'display': 'block', 'margin': '20px auto'}),
    dcc.Graph(id="graph", figure=fig),
    html.Div([
        html.H2("Most Supported Votes", style={'textAlign': 'center'}),
        dcc.Markdown(votes_list_most_html),
    ], style={'width': '50%', 'display': 'inline-block', 'verticalAlign': 'top'}),
    html.Div([
        html.H2("Least Supported Votes", style={'textAlign': 'center'}),
        dcc.Markdown(votes_list_least_html),
    ], style={'width': '50%', 'display': 'inline-block', 'verticalAlign': 'top'}),
])
